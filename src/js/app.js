...
const /** {HTMLElement} */ $currentDateElm = document.querySelector(
    "[data-current-date]"
  );
$currentDateElm.textContent = new Date().toDateString().replace(" ", ",");
...
/**
 * Shows a notebook creation field in the sidebar when the "Add Notebook" button in clicked.
...
const showNotebookField = function () {
  ...
  //Make notrbook field content editable and focus
 ...
 * Create new note
 * 
 * Attaches event listeners to a collection of DOM elements
 representing "Create Note" buttons.
