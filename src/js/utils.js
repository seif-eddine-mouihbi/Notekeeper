...
//  * @param {Object} db - The database containig the notebooks.
//  * @param {string} notebookId - The ID of the notebook to fing.
...
/**
 * Finds the index of a notebook in array of notebooks based on its ID
 *
